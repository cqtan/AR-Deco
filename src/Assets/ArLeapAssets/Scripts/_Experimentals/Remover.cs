...
/// <summary>
/// Not used! Check 'RemoveWithButton.cs' instead.
/// Idea was, when VuMarker for the trashcan is visible and an object is
/// being targeted, the object would slowly move towards the trashcan until
/// it collides with it. On collision, the object is destroyed. If it is
/// not targeted anymore before it is destroyed, then move it back to 
